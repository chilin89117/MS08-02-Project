...
var styles_MsgComponent = [".card[_ngcontent-%COMP%] {max-height: 200px;}"];
var RenderType_MsgComponent = i0.ɵcrt({ encapsulation: 0, styles: styles_MsgComponent, data: {} });
export { RenderType_MsgComponent as RenderType_MsgComponent };
function View_MsgComponent_1(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 7, "div", [], null, null, null, null, null)), (_l()(), i0.ɵted(-1, null, ["\n      "])), (_l()(), i0.ɵeld(2, 0, null, null, 1, "a", [["class", "btn btn-success btn-sm"]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
        var pd_0 = (_co.onLoadMsg() !== false);
        ad = (pd_0 && ad);
